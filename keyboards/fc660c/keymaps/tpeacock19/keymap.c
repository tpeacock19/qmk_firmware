...
enum tpeacock19_layers { _QWERTY, _COLEMAK, _FNM, _NUM};

enum tpeacock19_keycodes { QWERTY = SAFE_RANGE, COLEMAK };
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_COLEMAK] = LAYOUT(
        ...
        LSFT_T(), KC_X,   KC_C,   KC_D,  KC_V,  KC_Z,  KC_K,  KC_H,  KC_COMM,KC_DOT,KC_SLSH,KC_RSFT,     KC_UP,
        KC_CAPS, KC_LALT,KC_LGUI,          KC_SPC,                      FNM,KC_RCTL,KC_RALT,    KC_LEFT,KC_DOWN,KC_RGHT
                      ),
   /* FN layer
   * ,--------------------------------------------------------------------------------------------------.
