...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FNM] = LAYOUT(
        ...
        _______,_______,_______, QWERTY,COLEMAK,_______,_______,_______,KC_HOME,KC_PGUP,KC_SLCK,_______,_______,
        _______,_______,_______,_______,_______,_______,_______,_______,KC_END, KC_PGDN,KC_PAUS,KC_BTN1,     KC_MS_U,
