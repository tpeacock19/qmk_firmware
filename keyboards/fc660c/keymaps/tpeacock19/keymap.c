...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_NUM] = LAYOUT(
        ...
        _______,_______,_______,_______,_______,_______,_______,KC_7,KC_8,KC_9,KC_KP_MINUS,_______,_______,_______, KC_VOLD,
            NUM,_______,_______, QWERTY,COLEMAK,_______,KC_0,KC_4,KC_5,KC_6,KC_KP_PLUS,KC_KP_ASTERISK,_______,
        _______,_______,_______,_______,_______,_______,_______,KC_1,KC_2,KC_3,KC_KP_SLASH,KC_BTN1,     KC_MS_U,
        _______,  RESET,_______,            KC_0,             _______,_______,_______,          KC_MS_L,KC_MS_D,KC_MS_R
    )
};
