...
enum tpeacock19_layers { _COLEMAK, _QWERTY, _FNM, _NUM};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * +--------------------------------------------------------------------------------------------+-----+
   * | Caps  | Gui   | Alt  |               Space                | Fn  | Ctrl | Alt   | Left| Down|Right|
   * `--------------------------------------------------------------------------------------------------´
   */
  [_COLEMAK] = LAYOUT(
        ...
        KC_CAPS, KC_LGUI, KC_LALT,                    KC_SPC,                       FNM,    KC_RCTL, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
                      ),
    /* QWERTY Layer
   * ,--------------------------------------------------------------------------------------------------.
   * | Esc |  1  |  2  |  3  |  4  |  5  |  6  |  7  |  8  |  9  |  0  |  -  |  =  | Backspace |  | `   |
   ...
   * +--------------------------------------------------------------------------------------------+-----+
   * | Ctrl  | Gui   | Alt  |               Space                | Fn  | Ctrl | Alt   | Left| Down|Right|
   * `--------------------------------------------------------------------------------------------------´
   */
  [_QWERTY] = LAYOUT(
        KC_GESC, KC_1,   KC_2,   KC_3,  KC_4,  KC_5,  KC_6,  KC_7,  KC_8,    KC_9,   KC_0,    KC_MINS, KC_EQL,  KC_BSPC,  KC_GRV,
        ...
        KC_LCTL, KC_LGUI, KC_LALT,             KC_SPC,                       FNM,    KC_RCTL, KC_RALT, KC_LEFT, KC_DOWN, KC_RGHT
                     ),
   /* FN layer
   * ,--------------------------------------------------------------------------------------------------.
  ...
  [_FNM] = LAYOUT(
        ...
        _______,_______,KC_MPRV,KC_MPLY,KC_MNXT,_______,_______,_______,KC_PSCR,KC_SLCK,_______,_______,_______,_______,     KC_VOLD,
   ...
   * |        |     |     |     |     |     |     |  1  |  2  |  3  |  -  |     |     |        |  | Vol+|
   * |-----------------------------------------------------------------------------------------+  +-----+
   * |   NUM   |     |     |QWRTY|COLMK|     |  0  |  4  |  5  |  6  |  +  |  *  |             |
   * |--------------------------------------------------------------------------------------------+
   * |            |     |     |     |     |     |     |  7  |  8  |  9  |  /  | Mouse Btn 1 | MsU |
   * +--------------------------------------------------------------------------------------------+-----+
   * |       | Reset |      |                                    |      |      |      | MsL | MsD | MsR |
   * `--------------------------------------------------------------------------------------------------´
   */
  [_NUM] = LAYOUT(
        KC_GRV, KC_F1,  KC_F2,  KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8,  KC_F9,  KC_F10, KC_F11, KC_F12, KC_MUTE,     KC_VOLU,
        _______,_______,_______,_______,_______,_______,_______,KC_1,KC_2,KC_3,KC_KP_MINUS,_______,_______,_______, KC_VOLD,
            NUM,_______,_______, QWERTY,COLEMAK,_______,KC_0,KC_4,KC_5,KC_6,KC_KP_PLUS,KC_KP_ASTERISK,_______,
        _______,_______,_______,_______,_______,_______,_______,KC_7,KC_8,KC_9,KC_KP_SLASH,KC_BTN1,     KC_MS_U,
        _______,  RESET,_______,            _______,                   _______,_______,_______,          KC_MS_L,KC_MS_D,KC_MS_R
    )
};
